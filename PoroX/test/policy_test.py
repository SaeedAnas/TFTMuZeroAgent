...
from PoroX.models.mctx_agent import RepresentationNetwork, PredictionNetwork
...
def test_policy_network(hidden_state, key):
    policy_network = PredictionNetwork(test_config)
    ...
    policy, value = apply(variables, hidden_state)
